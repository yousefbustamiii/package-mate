...
export default function App() {
  ...
  const command = "curl -fsSL https://raw.githubusercontent.com/yousefbustamiii/package-mate/main/install.sh | bash";
          ...
          <div className="mx-auto w-full max-w-xl rounded-xl overflow-hidden border border-white/[0.08] text-left">
            ...
            <div className="px-5 py-4">
              <span className="text-sm md:text-base font-mono">
                ...
                <span className="text-white/70">https://raw.githubusercontent.com/yousefbustamiii/package-mate/main/install.sh | bash</span>
              </span>
            </div>
          </div>
        </div>
